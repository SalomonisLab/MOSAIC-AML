...
- **Result:** deployed arm C-index **0.706** (95% CI 0.655–0.758) against 0.751 CV / 0.787 sealed hold-out in BeatAML. 2-y AUC 0.806. Gain over age + cytogenetic risk **+0.035, P(ΔC≤0) = 0.029**. Risk tertiles separate **71.7% vs 13.7%** two-year survival, log-rank **p = 5.4e-10**, curves ordered and non-crossing (`fig_Sv4_tcga_km.png`).
